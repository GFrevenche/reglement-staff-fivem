...
**8.2** — Toute découverte de double staff entraîne un **renvoi immédiat**.

**8.3** — Le **recrutement de joueurs** pour un autre serveur depuis notre communauté est strictement interdit.

**8.4** — Faire de la **publicité** pour un autre serveur (en jeu, sur Discord ou en privé) est interdit et entraîne un renvoi.
