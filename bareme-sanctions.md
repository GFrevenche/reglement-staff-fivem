# Barème des sanctions joueurs

{% hint style="info" %}
Ce barème sert de référence pour appliquer des sanctions cohérentes et proportionnelles. Le staff doit s'y référer avant toute sanction.
{% endhint %}
...
| Infraction | 1ère fois | 2ème fois | 3ème fois |
| --- | --- | --- | --- |
| Freekill | Warn | Ban 1 jour | Ban 3 jours |
| Freekill massif | Ban 1 jour | Ban 3 jours | Ban 7 jours |
...
## Infractions très graves — Ban immédiat
...
* Les warns expirent après **30 jours** d'activité sans nouvelle infraction.
* Un **ban permanent** ne peut être prononcé que par un **Administrateur ou le Fondateur**.
* Toute sanction doit être accompagnée d'une **preuve** et notée dans `#logs-sanctions`.
{% endhint %}

{% hint style="info" %}
Ce barème est un guide. Le staff peut adapter la sanction en fonction du contexte, à condition de pouvoir **justifier sa décision** auprès d'un supérieur.
{% endhint %}
