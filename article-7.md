...
**7.4** — Un Modérateur Test ne peut **jamais agir seul** sur une situation complexe. Il doit être accompagné d'un Modérateur ou supérieur.

**7.5** — En cas de refus, le candidat peut **recandidater après 14 jours**.
...
| Étape | Description |
| --- | --- |
| 1. Candidature | Le joueur postule via le channel ou formulaire dédié |
| 2. Entretien | Un Administrateur ou le Fondateur évalue le candidat |
| 3. Intégration | Le candidat reçoit le rôle Modérateur Test |
| 4. Période d'essai | 7 à 14 jours d'évaluation en conditions réelles |
| 5. Décision | Validation → Modérateur / Refus → Fin de période |
